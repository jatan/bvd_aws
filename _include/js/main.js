...
BVD.fixNav = function(){
	...
	for (var i = nav.length - 1; i >= 0; i--) {
		if($(nav[i]).attr("href") == destination){
			$(nav[i]).parent().addClass('current');
		}
	}
}
